...
// Load Stylesheets
        ...
        // Slick
        wp_enqueue_style('slick-css', get_template_directory_uri() . '/css/slick.css', null, null);
        wp_enqueue_style('slick-theme', get_template_directory_uri() . '/css/slick-theme.css', null, null);
        wp_enqueue_script('slick-js', get_template_directory_uri() . '/js/slick.min.js', null, null, true);
...
function slider_short($atts)
{
    ...
    <div class="slider">
        ...
        foreach ($rows[$id]['images'] as $image) : ?>

            <div class="slider-item" data-slider-elems="<?php echo $rows[$id]['elems_to_show'] ?>"
                 data-slider-speed="<?php echo $rows[$id]['slider_speed'] ?>"
                 data-pagination="<?php echo $rows[$id]['slider_pagination'] ?>"
                 data-navigation="<?php echo $rows[$id]['slider_navigation'] ?>"
                 data-fade="<?php echo $rows[$id]['slide_fade_effect'] ?>"
                 data-autoplay="<?php echo $rows[$id]['slider_autoplay'] ?>">
